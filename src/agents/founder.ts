...
export async function runFounder(a: { ctx: IngestedContext; thesis: Thesis }) {
  return runSpecialist({
    agent: "founder",
    systemPreamble: "You are the firm's Founder Signal analyst. Score founder-market-fit, prior experience, network, and credibility. Flag anti-patterns from the thesis.",
