...
export async function runRisk(a: { ctx: IngestedContext; thesis: Thesis }) {
  return runSpecialist({
    agent: "risk",
    systemPreamble: "You are the firm's Trust & Risk analyst. Identify regulatory, smart-contract, centralization, and fraud risks. Escalate any anti-pattern hits from the thesis as HARD FLAGS.",
